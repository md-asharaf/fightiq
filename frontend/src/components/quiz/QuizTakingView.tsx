      ...
      <div className="container mx-auto p-4 md:p-8 max-w-3xl space-y-8 pb-32 pt-12">
        ...
        <div className="pt-12 flex justify-end">
          <Button 
            ...
            disabled={evaluating} 
            className="bg-primary hover:bg-primary/90 text-primary-foreground w-full md:w-auto px-16 h-14 text-lg font-bold rounded-none"
          >
        ...
        <AlertDialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <AlertDialogContent className="bg-background border border-border text-foreground rounded-none">
            <AlertDialogHeader>
              <AlertDialogTitle className="text-2xl font-bold text-primary">Incomplete Quiz</AlertDialogTitle>
            ...
            <AlertDialogFooter className="mt-6">
              <AlertDialogCancel className="bg-card border-border text-foreground hover:bg-muted rounded-none font-bold">Cancel</AlertDialogCancel>
              <AlertDialogAction onClick={confirmSubmit} className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-none font-bold">Submit Anyway</AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
        </AlertDialog>
      </div>
